...
REM
REM Generated by Vivado on Wed Dec 10 04:24:30 +0530 2025
...
echo "xvlog --incr --relax -prj tb_puzzle_1_vlog.prj"
call xvlog  --incr --relax -prj tb_puzzle_1_vlog.prj -log xvlog.log
