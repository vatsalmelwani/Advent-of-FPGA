...
HD_PWD='C:/Users/Vatsal Melwani/EE/FPGA/Advent_of_Code_JS/Puzzle 4/part_2/part_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log puzzle4_part2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source puzzle4_part2.tcl
