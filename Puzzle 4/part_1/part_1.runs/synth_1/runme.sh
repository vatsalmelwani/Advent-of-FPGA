...
HD_PWD='C:/Users/Vatsal Melwani/EE/FPGA/Advent_of_Code_JS/Puzzle 4/part_1/part_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log puzzle4_part1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source puzzle4_part1.tcl
